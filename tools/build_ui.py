...
ASSETS = ('index.html', 'forward.css', 'forward.js', 'portal-management.js', 'portal-auth.js')
...
def main():
    ...
    print('Built five public assets. Backend, credentials and historical content excluded.')
