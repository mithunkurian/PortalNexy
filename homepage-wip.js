...
const HomepageWIP=(()=>{
  ...
  function render(){
    ...
    return `<div class="home-wip">
      ...
      <div class="hw-heading"><div><span>COMMAND CENTRE</span><h2>Portfolio health at a glance</h2></div><div class="hw-heading-actions"><button class="hw-ask" onclick="openNEXChat()"><span class="material-symbols-outlined">psychology</span>Ask NEX</button><div class="hw-filters">${dropdown('Strategy','strategy',[['all','All strategies'],['etf','ETF rotation'],['crypto','BTC / ETH']],strategy)}${dropdown('Time frame','period',Object.entries(labels),period)}</div></div></div>
